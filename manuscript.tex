...
We first compute the MLE estimated by iteratively reweighted least squares in \texttt{R}. For the LSM we use the posterior mode. In the cases where edges are Binomial or Poisson distributed, we scale the estiamtes % figure out how to do this.
